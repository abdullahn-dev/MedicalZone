...
public class AdminProfileActivity extends AppCompatActivity {
    ...
    private EditText editName, editEmail, editSpecialization, editExperience;
    ...
    private TextView viewName, viewEmail, viewSpecialization, viewExperience;
    ...
    private void displayProfile() {
        ...
        if (imageUriString != null) {
            ...
            // Set default image or placeholder if no image is available
            viewProfileImage.setImageResource(R.drawable.doc1); // Example default image
        }
    }
}
